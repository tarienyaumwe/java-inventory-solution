...
String u;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Inventory Going Out");
        ...
        sellingPriceLab.setText("Product value");
        ...
        productCodeLab1.setText("Person's Code");
        ...
        jTabbedPane1.addTab("Stock Out Details", jPanel1);
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        supplierInfoLab.setText("Given to "+cus);
        ...
        if(dateChooser.getDate()==null || quantityTxt.getText().equals("") || customerCodeTxt.getText().equals("") ){
            ...
            try{
                ...
                if(rs.next()){
                    ...
                    JOptionPane.showMessageDialog(null, "Please enter valid person's code!");
                }
            }catch(Exception e){
                e.printStackTrace();
            }
    ...
    private void customerCodeTxtKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_customerCodeTxtKeyReleased
        ...
        try{
            ...
            if(rs.next()){
                ...
                customerNameLab.setText("Not associated with any Person!");
            }
        }catch(Exception e){
            e.printStackTrace();
        }
